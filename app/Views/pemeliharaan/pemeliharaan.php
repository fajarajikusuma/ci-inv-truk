                                        ...
                                        <div class="d-flex justify-content-center align-items-center gap-1">
                                            <?php if ($row['sopir_nonaktif']): ?>
                                                <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                    data-bs-target="#danger-<?= $row['id_kendaraan']; ?>"> <i
                                                        class="bi bi-x-circle"></i> Nonaktif
                                                </button>
                                            <?php else: ?>
                                                <a href="<?= base_url('pemeliharaan/detail/' . $row['enc_id']); ?>"
...
<?php foreach ($pemeliharaan as $row): ?>
    <div class="modal-danger me-1 mb-1 d-inline-block">
        <div class="modal fade text-left" id="danger-<?= $row['id_kendaraan']; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Kendaraan dengan no. polisi <b><?= esc($row['nopol']); ?></b> tidak memiliki sopir aktif.
                            Pastikan status sopir sudah diaktifkan / mengubah data sopir pada kendaraan agar dapat menambah
                            data pemeliharaan.</p>
                    </div>
